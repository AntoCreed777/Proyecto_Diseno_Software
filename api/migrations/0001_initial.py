# Generated by Django 5.2.1 on 2025-07-02 05:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('cliente', 'Cliente'), ('conductor', 'Conductor'), ('despachador', 'Despachador'), ('admin', 'Admin')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('en_ruta', 'En ruta'), ('disponible', 'Disponible'), ('no disponible', 'No disponible')], default='disponible', max_length=100)),
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('largo', models.FloatField(validators=[django.core.validators.MinValueValidator(0.01, 'El valor debe ser mayor a 0.')])),
                ('ancho', models.FloatField(validators=[django.core.validators.MinValueValidator(0.01, 'El valor debe ser mayor a 0.')])),
                ('alto', models.FloatField(validators=[django.core.validators.MinValueValidator(0.01, 'El valor debe ser mayor a 0.')])),
                ('peso', models.FloatField(validators=[django.core.validators.MinValueValidator(0.01, 'El valor debe ser mayor a 0.')])),
                ('fecha_registro', models.DateTimeField(auto_now_add=True)),
                ('fecha_entrega', models.DateTimeField(blank=True, null=True)),
                ('estado', models.CharField(choices=[('en_bodega', 'En bodega'), ('en_ruta', 'En ruta'), ('entregado', 'Entregado')], default='en_bodega', max_length=10)),
                ('ubicacion_actual_lat', models.FloatField(default=-36.8302049)),
                ('ubicacion_actual_lng', models.FloatField(default=-73.0372293)),
                ('ubicacion_actual_texto', models.CharField(default='Universidad de Concepcion, Concepcion, Bio Bio, Chile', max_length=200)),
                ...
                ('telefono_destinatario', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paquete', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='notificaciones', to='api.paquete')),
            ],
        ),
        migrations.CreateModel(
            name='Ruta',
            fields=[
                ...
                ('fecha_en_que_se_ejecuto', models.DateTimeField(blank=True, help_text='Fecha y hora cuando se ejecutó la ruta', null=True)),
                ...
                ('duracion_real_minutos', models.PositiveIntegerField(blank=True, help_text='Duración real que tomó al conductor completar la ruta (en minutos)', null=True)),
