# Generated by Django 5.2.1 on 2025-07-07 00:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rut_destinatario', models.CharField(help_text='RUT del destinatario (formato: 12.345.678-9)', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_antiguo', models.CharField(blank=True, choices=[('en_bodega', 'En bodega'), ('en_ruta', 'En ruta'), ('entregado', 'Entregado')], help_text='Estado antiguo del paquete', max_length=10, null=True)),
                ('estado_nuevo', models.CharField(blank=True, choices=[('en_bodega', 'En bodega'), ('en_ruta', 'En ruta'), ('entregado', 'Entregado')], help_text='Estado nuevo del paquete', max_length=10, null=True)),
